...
app.use(body_parser__WEBPACK_IMPORTED_MODULE_2___default.a.json()).use("/", _routes_index__WEBPACK_IMPORTED_MODULE_3__["default"]);
app.listen(process.env.PORT, function () {
  return console.log("I AM LISTENINGss...");
});
...
router.post("/postdeneme", function (req, res) {
